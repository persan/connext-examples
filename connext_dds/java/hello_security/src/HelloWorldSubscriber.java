...
java -Djava.ext.dirs=$NDDSHOME/class HelloWorldPublisher <domainId>

java -Djava.ext.dirs=$NDDSHOME/class HelloWorldSubscriber <domainId>  
*/
...
public class HelloWorldSubscriber {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // --- Run --- //
        subscriberMain(domainId, sampleCount, profile);
    }
    ...
    private static void subscriberMain(int domainId, int sampleCount, String profile) {
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((HelloWorld)_dataSeq.get(i)).toString("Received data",0));
