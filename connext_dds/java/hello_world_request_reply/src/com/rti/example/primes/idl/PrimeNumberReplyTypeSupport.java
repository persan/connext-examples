...
public class PrimeNumberReplyTypeSupport extends TypeSupportImpl {
    ...
    private static final java.lang.String TYPE_NAME = "PrimeNumberReply";
    ...
    */
    ...
    public static TypeCode getTypeCode(){
        return PrimeNumberReplyTypeCode.VALUE;
    }
    ...
    */
    ...
    public long get_serialized_sample_max_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getIntSequenceMaxSizeSerialized(
            currentAlignment, 
            (com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE))
        ;
        currentAlignment +=com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_max_size(
            endpoint_data,
            false,
            final_encapsulation_id,
            currentAlignment)
    ...
    public long get_serialized_sample_min_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getIntSequenceMaxSizeSerialized(currentAlignment,  0)
        ;
        currentAlignment +=com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_min_size(
            endpoint_data,
            false,
            final_encapsulation_id,
            currentAlignment)
        ...
        java.lang.Object sample)
    {
        ...
        currentAlignment += _cdrPrimitiveType.getIntSequenceSerializedSize(
            epd.getAlignment(currentAlignment),
            typedSrc.primes );      
        ...
        currentAlignment += com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.status);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=_cdrPrimitiveType.getIntSequenceMaxSizeSerialized(
            ...
            (com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE))
        ;
        currentAlignment +=com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(
            endpoint_data,
            false,
            final_encapsulation_id,
            currentAlignment)
    ...
    boolean serialize_sample, java.lang.Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ...
                dst.inBaseClass = false;
                dst.writeIntSeq(typedSrc.primes,(com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE));
                com.rti.example.primes.idl.PrimeNumberCalculationStatusTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.status, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                src.readIntSequence(typedDst.primes, (com.rti.example.primes.idl.PRIME_SEQUENCE_MAX_LENGTH.VALUE));
