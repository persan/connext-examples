...
public class PrimeNumberCalculationStatusTypeSupport extends TypeSupportImpl {
    ...
    private static final java.lang.String TYPE_NAME = "PrimeNumberCalculationStatus";
    ...
    */
    ...
    public static TypeCode getTypeCode(){
        return PrimeNumberCalculationStatusTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>PrimeNumberCalculationStatus</code>
    * type.
    */
    @Override 
        ...
        if(deserialize_sample) {
            ...
            if (dst == null) {
                ...
                ((DefaultEndpointData)endpoint_data).getSampleAssignabilityProperty().acceptUnknownEnumValue) {
                    dst = PrimeNumberCalculationStatus.valueOf(
                        0);
                } else {
    ...
    protected PrimeNumberCalculationStatusTypeSupport() {
        ...
        super(TYPE_NAME, false, PrimeNumberCalculationStatusTypeCode.VALUE, PrimeNumberCalculationStatus.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
