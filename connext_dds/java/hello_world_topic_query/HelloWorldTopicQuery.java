...
public class HelloWorldTopicQuery   implements Copyable, Serializable{

    public int id = (int)0;
    public String message= (String)""; /* maximum length = (255) */

    public HelloWorldTopicQuery() {

    }
    public HelloWorldTopicQuery (HelloWorldTopicQuery other) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HelloWorldTopicQuery otherObj = (HelloWorldTopicQuery)o;
    ...
    public int hashCode() {
        ...
        int __result = 1;
        __result = __prime * __result + (int)id;
    ...
    * This method could be placed into <code>HelloWorldTopicQueryTypeSupport</code>
    ...
    */
    public java.lang.Object copy_from(java.lang.Object src) {
        ...
        HelloWorldTopicQuery typedSrc = (HelloWorldTopicQuery) src;
        HelloWorldTopicQuery typedDst = this;
