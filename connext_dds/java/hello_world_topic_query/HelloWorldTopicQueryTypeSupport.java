...
public class HelloWorldTopicQueryTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "HelloWorldTopicQuery";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HelloWorldTopicQueryTypeSupport _singleton
    = new HelloWorldTopicQueryTypeSupport();
    ...
    */
    public static HelloWorldTopicQueryTypeSupport get_instance() {
        return _singleton;
    }

    public static HelloWorldTopicQueryTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HelloWorldTopicQueryTypeCode.VALUE;
    }

    @Override
    public java.lang.Object create_data() {
        return HelloWorldTopicQuery.create();
    }
    ...
    public java.lang.Object create_key() {
        return new HelloWorldTopicQuery();
    }
    ...
    public java.lang.Class<?> get_type() {
        return HelloWorldTopicQuery.class;
    }
    ...
    * <code>this</code> is not a <code>HelloWorldTopicQuery</code>
    * type.
    */
    @Override 
    public java.lang.Object copy_data(java.lang.Object destination, java.lang.Object source) {

        HelloWorldTopicQuery typedDst = (HelloWorldTopicQuery) destination;
        HelloWorldTopicQuery typedSrc = (HelloWorldTopicQuery) source;
        ...
        java.lang.Object sample)
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        HelloWorldTopicQuery typedSrc = (HelloWorldTopicQuery) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.message );
    ...
    boolean serialize_sample, java.lang.Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.message,255);
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            HelloWorldTopicQuery typedDst = (HelloWorldTopicQuery) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                ...
                typedDst.message = src.readString(255);
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (deserialize_key) {
            ...
            HelloWorldTopicQuery typedDst = (HelloWorldTopicQuery) sample;
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            if (!xcdr1 && !inBaseClass_tmp) {
    ...
    */
    ...
    java.lang.Object key) {
        HelloWorldTopicQuery typedDst
        = (HelloWorldTopicQuery) instance;
        HelloWorldTopicQuery typedSrc
    ...
    */
    ...
    int mask) {
        return new HelloWorldTopicQueryDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new HelloWorldTopicQueryDataReader(native_reader, listener, mask, this);   
    ...
    protected HelloWorldTopicQueryTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true, HelloWorldTopicQueryTypeCode.VALUE, HelloWorldTopicQuery.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HelloWorldTopicQueryTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, HelloWorldTopicQueryTypeCode.VALUE, HelloWorldTopicQuery.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
