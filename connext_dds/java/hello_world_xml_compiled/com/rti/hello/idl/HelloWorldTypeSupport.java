...
public class HelloWorldTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rti.hello.idl.MAX_NAME_LEN.VALUE))+1)
        ;
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rti.hello.idl.MAX_MSG_LEN.VALUE))+1)
        ;
        currentAlignment += _cdrPrimitiveType.getIntMaxSizeSerialized(currentAlignment)
        ;
        if (include_encapsulation) {
        ...
        java.lang.Object sample)
    {
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.sender );
