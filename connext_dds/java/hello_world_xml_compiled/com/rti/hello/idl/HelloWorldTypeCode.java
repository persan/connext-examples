...
public class  HelloWorldTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("sender", false, (short)-1, true, new TypeCode(TCKind.TK_STRING,(com.rti.hello.idl.MAX_NAME_LEN.VALUE)), 0, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        memberAnnotation.default_annotation(AnnotationParameterValue.EMPTY_STRING);
        sm[__i] = new  StructMember("message", false, (short)-1,  false, new TypeCode(TCKind.TK_STRING,(com.rti.hello.idl.MAX_MSG_LEN.VALUE)), 1, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        ...
        sm[__i] = new  StructMember("count", false, (short)-1,  false, TypeCode.TC_LONG, 2, false, memberAnnotation);__i++;
