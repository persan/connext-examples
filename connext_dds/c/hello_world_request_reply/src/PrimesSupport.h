...
extern "C" {
    ...
    */
    ...
    DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_C(PrimeNumberRequestDataWriter, PrimeNumberRequest);
    ...
    */
    ...
    DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_C(PrimeNumberReplyDataWriter, PrimeNumberReply);
