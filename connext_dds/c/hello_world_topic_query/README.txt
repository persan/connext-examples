...
with this example:
- HelloWorldTopicQuery_publisher.c
- HelloWorldTopicQuery_subscriber.c
...
x64Darwin14clang6.0, run:
   ...
   rtiddsgen -language C -example x64Darwin14clang6.0 -ppDisable HelloWorldTopicQuery.idl
...
After running rtiddsgen, you will see messages that look like this:
	...
	WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not 
        be overwritten : <example_dir>\HelloWorldTopicQuery_publisher.c
	WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not
        be overwritten : <example_dir>\HelloWorldTopicQuery_subscriber.c
	WARN com.rti.ndds.nddsgen.emitters.FileEmitter File exists and will not 
