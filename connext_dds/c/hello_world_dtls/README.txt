...
to compile with the gcc 7.3.0 compiler, run rtiddsgen for the x64Linux4gcc7.3.0 
architecture:
...
OpenSSL bundles for the architecture x64Linux4gcc7.3.0 and you are using a 
c-shell:
...
application will be compiled with Visual Studio 2015, run rtiddsgen for the
i86Win32VS2015 architecture:

    rtiddsgen -language C -example i86Win32VS2015 HelloWorld.idl

Open the generated solution file for your architecture with Visual Studio. Build the
...
RTI and to a supported version of the OpenSSL libraries. For example:
    ...
    set Path=%NDDSHOME%\third_party\openssl-<version>\i86Win32VS2015\release\bin;%Path%

Set NDDS_DISCOVERY_PEERS as indicated in the section DTLS locators.

Run the subscriber by typing:

    objs\i86Win32VS2015\HelloWorld_subscriber.exe <Domain_ID> <Number_of_Samples>

and run the publisher by typing:

    objs\i86Win32VS2015\HelloWorld_publisher.exe <Domain_ID> <Number_of_Samples>
