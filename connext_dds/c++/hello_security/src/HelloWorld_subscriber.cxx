...
extern "C" int subscriber_main(int domainId, int sample_count, const char *profile)
{
    ...
    retcode = DDSDomainParticipantFactory::get_instance()->
            get_participant_qos_from_profile(participant_qos,
                    "SecurityExampleProfiles", profile);
