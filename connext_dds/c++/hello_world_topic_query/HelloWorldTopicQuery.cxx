...
DDS_TypeCode * HelloWorldTopicQuery_get_typecode(void)
{
    ...
    HelloWorldTopicQuery_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long_w_new;
...
RTIXCdrSampleAccessInfo *HelloWorldTopicQuery_get_sample_seq_access_info()
{
    static RTIXCdrSampleAccessInfo HelloWorldTopicQuery_g_seqSampleAccessInfo = {
        RTI_XCDR_TYPE_BINDING_CPP, \
        {sizeof(HelloWorldTopicQuerySeq),0,0,0}, \
        RTI_XCDR_FALSE, \
        DDS_Sequence_get_member_value_pointer, \
        HelloWorldTopicQuerySeq_set_member_element_count, \
        NULL, \
        NULL, \
        NULL \
    };

    return &HelloWorldTopicQuery_g_seqSampleAccessInfo;
}
...
RTIXCdrSampleAccessInfo *HelloWorldTopicQuery_get_sample_access_info()
{
    ...
    HelloWorldTopicQuery_g_sampleAccessInfo.useGetMemberValueOnlyWithRef =
    RTI_XCDR_TRUE;

    HelloWorldTopicQuery_g_sampleAccessInfo.getMemberValuePointerFcn = 
    HelloWorldTopicQuery_get_member_value_pointer;
...
namespace rti { 
    namespace xcdr {
        const RTIXCdrTypeCode * type_code<HelloWorldTopicQuery>::get() 
        {
            return (const RTIXCdrTypeCode *) HelloWorldTopicQuery_get_typecode();
        }
