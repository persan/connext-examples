...
HelloWorldPluginSupport_create_key_ex(RTIBool allocate_pointers){
    ...
    key = new (std::nothrow) HelloWorldKeyHolder();
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        HelloWorldPluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
        HelloWorldPluginSupport_destroy_key);
    ...
    serializedKeyMaxSizeV2 =  HelloWorldPlugin_get_serialized_key_max_size_for_keyhash(
        epd,
