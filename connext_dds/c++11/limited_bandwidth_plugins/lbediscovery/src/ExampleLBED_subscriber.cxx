/**
 * @file ExampleLBED_subscriber.cxx
 *
 * @brief Subscription example of type ExampleLBED.
...
int process_data(dds::sub::DataReader<ExampleLBED> reader)
{
    // Take all samples
    int count = 0;
    dds::sub::LoanedSamples<ExampleLBED> samples = reader.take();
...
void run_subscriber_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    while (!application::shutdown_requested && samples_read < sample_count) {
        std::cout << "ExampleLBED subscriber sleeping up to 1 sec..." << std::endl;
