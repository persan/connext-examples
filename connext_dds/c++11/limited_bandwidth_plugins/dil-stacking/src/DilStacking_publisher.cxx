/**
 * @file DilStacking_publisher.cxx
 *
 * @brief Publication example of type DilStacking.
...
void run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::domain::DomainParticipant participant(
        ...
        dds::core::QosProvider::Default().participant_qos(
            "DilStacking_Library::DilStacking_Publisher_Profile"));
    ...
    dds::pub::DataWriter<DilStacking> writer(
        publisher,
        topic,
    ...
    samples_written++) {
        ...
        std::cout << "Writing DilStacking, count " << samples_written << std::endl;
