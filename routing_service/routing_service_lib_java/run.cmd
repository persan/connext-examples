...
IF DEFINED RTI_EXAMPLE_JDK_HOME (
    SET JAVA="%RTI_EXAMPLE_JDK_HOME%\bin\java"
)
...
REM Use a configuration file if specified
set CFG_FILE=%1

%JAVA% -classpath objs;",;%NDDSHOME_NQ%\lib\java\nddsjava.jar;%NDDSHOME_NQ%\lib\java\rtiroutingservice.jar" RunRoutingService %CFG_FILE%
