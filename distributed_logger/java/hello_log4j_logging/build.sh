...
$JAVAC -d objs -classpath "$NDDSHOME/lib/java/nddsjava.jar":"$NDDSHOME/lib/java/distlog.jar":"$NDDSHOME/resource/app/lib/java/log4j-core-2.17.1.jar":"$NDDSHOME/resource/app/lib/java/log4j-api-2.17.1.jar" $ALL_SRC
