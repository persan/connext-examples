...
if [ `uname` = "Darwin" ]; then
   ...
   LIBPATH=${NDDSHOME}/lib/${RTI_EXAMPLE_ARCH}:${LIBPATH}
   export LIBPATH
else
...
# Run example
$JAVA -classpath objs:"$NDDSHOME"/lib/java/nddsjava.jar:"$NDDSHOME/lib/java/distlog.jar":"$NDDSHOME/resource/app/lib/java/log4j-api-2.17.1.jar":"$NDDSHOME/resource/app/lib/java/log4j-core-2.17.1.jar" com.rti.hello.Hello "$@"
